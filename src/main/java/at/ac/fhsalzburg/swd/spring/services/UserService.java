...
public class UserService implements UserServiceInterface {
    ...
    public boolean addUser(String username, String fullName, String eMail, String Tel,
            Date BirthDate, String password, String role, String iban, String matrikelnummer) {
        ...
        if (username != null && username.length() > 0 //
            ...
            User newCustomer = new User(username, fullName, eMail, Tel, BirthDate,
            		passwordEncoder.encode(password), role, userDetails.getJwtToken(), iban, matrikelnummer);
